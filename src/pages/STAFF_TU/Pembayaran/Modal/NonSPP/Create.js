...
function Create({ openModalTransaction, setOpenModalTransaction, TableBill, item, studentProfile }) {
  ...
  return (
    ...
    >
      <Box sx={{ mt: -2 }}>
        <TableBill />
        <TextField value={note} onChange={(i) => setNote(i?.target.value)} label="Catatan" sx={{ mt: 2 }} fullWidth />
        <TextField
          value={value}
